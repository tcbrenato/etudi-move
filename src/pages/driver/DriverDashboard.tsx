    ...
    <AppLayout navItems={navItems}>
      <div className="animate-fade-in">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { icon: Route, title: 'Publier un trajet', desc: 'Bientôt disponible — publiez vos trajets pour les étudiants.', soon: true },
            { icon: Car, title: 'Mes trajets', desc: 'Bientôt disponible — consultez et gérez vos trajets publiés.', soon: true },
